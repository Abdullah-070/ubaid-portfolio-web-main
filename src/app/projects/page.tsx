...
export const metadata: Metadata = {
  title: "Projects | Ubaid - Software Developer",
  description:
    "Explore projects developed by Ubaid, a software developer specializing in React, Next.js, TypeScript, and modern web technologies.",
  keywords: [
